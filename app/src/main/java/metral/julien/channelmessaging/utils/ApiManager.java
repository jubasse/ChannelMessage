...
public class ApiManager {
    ...
    public static String BASE_URL_VERIFY_TOKEN = BASE_URL_API+"?function=isaccesstokenvalid";
    ...
    public String verifyAccessToken(HashMap<String, String> postDatas)
    {
        return this.performPostCall(BASE_URL_VERIFY_TOKEN,postDatas);
    }
